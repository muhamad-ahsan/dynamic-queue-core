...
using MessageQueue.CofigurationProvider.Json.Concrete;
...
namespace MessageQueue.Receiver
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Please select the Message Queue (Receiver):" + Environment.NewLine + "1- ServiceBus");
        ...
        */
        ...
        public static void Test_ServiceBusFaF_Receive()
        {
            try
            {
                ...
                // Creating queue object from factory.
                inboundMessageQueue = MessagingQueueFactory.CreateInboundFaF<string>(new JsonSettingsConfigurationProvider(), "ServiceBusFaFInbound", new NQueueLogger("Default"));
                ...
                // Checking is there any message.
                Console.WriteLine("Queue has message: {0}", inboundMessageQueue.HasMessage().Result);
