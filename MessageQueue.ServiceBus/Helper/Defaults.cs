...
namespace MessageQueue.ServiceBus.Helper
{
    ...
    internal static class Defaults
    {
        ...
        public const long MaxSizeInMegabytes = 1024;
        public static TimeSpan LockDurationInSeconds = TimeSpan.FromSeconds(300); // 5 minutes and this is the max value as of 25-April-2019
